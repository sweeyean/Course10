## Predict next word based on previously computed ngram csv file
## CSV files(n2.csv, n3.csv, n4.csv, n5.csv)
## ----------
# This script uses the CSV files containing n-grams for n=2:5.
# The structure of the resulting dataframe should be:
# <freq> <word1> <word_nth> <word_nth> ..<word_nth> for the Nth-gram.
# i.e <freq> <word1> <word2> <word3> for the 3-gram,
...
## Load in ngrams from capstone_word_prediction.RData.
## make sure this is found in load("data/capstone_word_prediction.RData", envir=.GlobalEnv) server.R script.
if (!exists("n5")) {
...
## Implement Backward_offset algorithm
Backward_offset <- function(x, alpha=0.4, getNrows=20, showNresults=1,
